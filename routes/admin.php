...
Route::middleware(['admin'])->group(function () {
    ...
    Route::prefix('admin/draft')->group(function () {
        ...
        Route::post('/accept/{id}', [DraftController::class, 'acceptDraft'])->name('admin.draft.accept');
        Route::post('/reject/{id}', [DraftController::class, 'rejectDraft'])->name('admin.draft.reject');
    });
    Route::prefix('admin/confirm')->group(function () {
        //complete booking 
        Route::get('/complete', [ConfirmUserController::class, 'complete'])->name('admin.confirm.completebooking');
        Route::get('/cancel', [ConfirmUserController::class, 'cancel'])->name('admin.confirm.cancel');
        ...
        Route::post('/complete/{id}', [ConfirmUserController::class, 'bookingcomplete'])->name('admin.confirm.complete');
    });
