                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="number" name="max_passengers" class="form-control"
                                            placeholder="Max Passengers" value="{{ old('max_passengers') }}" required>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="number" name="max_suitecases" class="form-control"
                                            placeholder="Max Suitecases" value="{{ old('max_suitecases') }}" required>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="number" name="max_hand_luggage" class="form-control"
                                            placeholder="Max Hand Luggage" value="{{ old('max_hand_luggage') }}" required>
                                    ...
                                    <div style="display: none">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price / mile <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="price" class="form-control" placeholder="Price"
                                                value="0" oninput="validateDecimal(this)" required>
                                            @error('price')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" name="min_booking_price" class="form-control"
                                                placeholder="Minimum Booking Price" value="0"
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" name="price_after_10_miles" class="form-control"
                                                ...
                                                value="0" oninput="validateDecimal(this)"
                                                required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 10 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_10_miles"
                                                class="form-control" placeholder="Price after 10 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 20 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_20_miles"
                                                class="form-control" placeholder="Price after 20 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 30 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_30_miles"
                                                class="form-control" placeholder="Price after 30 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 40 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_40_miles"
                                                class="form-control" placeholder="Price after 40 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 50 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_50_miles"
                                                class="form-control" placeholder="Price after 50 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 60 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_60_miles"
                                                class="form-control" placeholder="Price after 60 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 70 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_70_miles"
                                                class="form-control" placeholder="Price after 70 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 80 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_80_miles"
                                                class="form-control" placeholder="Price after 80 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 90 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_90_miles"
                                                class="form-control" placeholder="Price after 90 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 100 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_100_miles"
                                                class="form-control" placeholder="Price after 100 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 110 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_110_miles"
                                                class="form-control" placeholder="Price after 110 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 120 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_120_miles"
                                                class="form-control" placeholder="Price after 120 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 130 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_130_miles"
                                                class="form-control" placeholder="Price after 130 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 140 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_140_miles"
                                                class="form-control" placeholder="Price after 140 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Price after 150 miles <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="airport_price_after_150_miles"
                                                class="form-control" placeholder="Price after 150 miles"
                                                value="0"
                                                oninput="validateDecimal(this)" required>
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <textarea name="detail_page_description" class="form-control" rows="5" placeholder="Detail Page Description"
                                            required>{{ old('detail_page_description') }}</textarea>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <input type="text" data-role="tagsinput" name="features" class="form-control"
                                            placeholder="Add Features" value="{{ old('features') }}">
                                        @error('features')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
