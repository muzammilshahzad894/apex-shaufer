                    ...
                    <form action="{{ route('booking.store') }}" method="POST" id="booking-form">
                        ...
                        <div class="new_form step1" id="forms">
                            ...
                            <div class="gap-3">
                                ...
                                @endphp
                                 <label for="service" style="padding: 10px 0px;">Select Service:</label>
                        ...
                        <div class="step3 new_form">
                            ...
                            <div class="border-botom">
                                ...
                                <div class=" meet_greet airportservice"
                                    style="gap:10px;align-items:center;gap: 10px;align-items: center;margin-bottom: 30px;"
                        ...
                        <div class="step4 new_form">
                            <div class="summary">
                                ...
                                <div class="d-flex gap-4" style="display: none !important">
                                    <strong>Fleet Price:</strong>
                                    <div>
                                        <p id="summary-fleet-price"></p>
                                    </div>
                                </div>
                                <div class="d-flex gap-4" id="summary-child-seat_price_div" style="display: none !important">
                                    <strong>Child Seat:</strong>
                                    <div>
                                        <p id="summary-child-seat_price"></p>
                                    </div>
                                </div>
                                <div class="d-flex gap-4" id="summary-extra-lauggage_price_div" style="display: none !important">
                                    <strong style="display: none !important">Meet & Greet:</strong>
                                ...
                                <div class="d-none gap-4 " id="summary-meet-greet_price_div" style="display: none !important">
