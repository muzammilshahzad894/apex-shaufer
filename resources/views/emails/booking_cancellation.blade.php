                ...
                <table width="600" cellpadding="20" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 8px; margin-top: 20px;">
                    ...
                    <tr>
                        <td style="background-color: #ef8e1c; padding: 20px; color: #ffffff;">
                            @if($for_admin)
                                <h3 style="text-align: center; color: #ffffff;">Booking Rejected</h3>
                            @else
                                <h3 style="text-align: center; color: #ffffff;">Your Booking with Bristol Cabwise is Rejected</h3>
                            @endif
                            @if($for_admin)
                            ...
                            @else
                                <p style="color: #ffffff;">We are sorry to inform you that your booking with Bristol Cabwise has been rejected. Please find the booking details below:</p>
                            @endif
